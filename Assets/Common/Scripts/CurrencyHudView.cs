...
namespace Unity.Services.Samples
{
    public class CurrencyHudView : MonoBehaviour
    {
        ...
        public void SetBalances(GetBalancesResult getBalancesResult)
        {
            ...
            {
                GameManager.instance.ShowDubug($"Currency balances updated. Value(s): {currenciesString.Remove(0, 2)}");
            }
            else
            {
                GameManager.instance.ShowDubug("Currency balances updated -- none found.");
            }
        }
